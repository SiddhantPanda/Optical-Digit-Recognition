...
def train_model():
    ...
    # Excluding the data from ROW 1 which is the Column Name Row. Separating the Input data from the Output data.
    ...
    # Create a model
    # clf = DTC()
    clf = RFC(n_estimators=50) # Layman's term: Number of trees in the forest.
